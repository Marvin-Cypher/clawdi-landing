  ...
  return (
    <section className="section-padding container max-w-screen-xl">
      <h2 className="text-4xxl leading-tight tracking-tight md:text-5xl">
        Meet the Clawdi team
      </h2>
      <p className="text-muted-foreground mt-3 max-w-2xl text-lg leading-snug">
        Clawdi is built by a small team of engineers, designers, and OpenClaw
        contributors who believe AI assistants should be accessible to
        everyone — not just developers with spare servers.
      </p>

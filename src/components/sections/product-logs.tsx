      ...
      <div className="flex flex-col justify-between gap-3">
        <div className="space-y-6">
          <h2 className="text-4xxl leading-none tracking-tight text-balance md:text-6xl lg:max-w-xs">
            Full <br className="hidden lg:block" />
            <span className="text-gradient">
              Conversation <br className="hidden lg:block" /> Logs
            </span>
          </h2>
          ...
          <p className="text-muted-foreground mt-3 max-w-lg text-lg leading-snug">
            Every conversation, tool call, and agent action is logged. See
            exactly what your OpenClaw assistant did and why.
          </p>
          <div>
            <Button
              variant="ghost"

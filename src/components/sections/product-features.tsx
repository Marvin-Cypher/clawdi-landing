  ...
  return (
    <div ref={ref} className="relative overflow-hidden px-5 pb-5 lg:h-full">
      <div className="absolute">
        <span className="text-muted-foreground text-xl">Messages Routed</span>
      ...
      {isInView && (
        ...
        >
          <AreaChart
            data={[
              { month: 'Nov', messages: 800 },
              { month: 'Dec', messages: 3200 },
              { month: 'Jan', messages: 7500 },
              { month: 'Feb', messages: 14280 },
            ]}
          >
            <defs>
...
function Card5() {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="relative z-10 space-y-1.5 px-3 py-2.5">
          ...
          >
            ...
            <h3 className="text-[0.625rem] font-bold">Task Trigger</h3>
          </motion.div>
      ...
      >
        AI Action:{' '}
        <span className="text-gradient">Route to research agent and reply</span>
      </motion.p>
      <motion.div
      ...
      >
        ...
        <div className="mt-1 flex items-center gap-1.5">
          <NumberTicker startValue={800} value={1247} className="text-sm" />

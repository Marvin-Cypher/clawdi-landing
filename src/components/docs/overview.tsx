...
const QUICK_START_SECTIONS = [
  {
    title: 'Installation',
    description:
      'Get started with Clawdi by installing the necessary dependencies and setting up your environment.',
    icon: Package,
  ...
  },
  {
    title: 'Core Concepts',
    description:
      'Learn the fundamental concepts and architecture behind Clawdi and OpenClaw.',
    icon: BookOpen,
  ...
  },
  {
    title: 'File Systems',
    description:
      'Understand how to manage and organize files efficiently within the Clawdi ecosystem.',
    icon: FileText,
    ...
    <div className="text-center">
      <div className="mx-auto flex max-w-2xl flex-1 flex-col items-center gap-5">
        ...
        <h1 className="!mb-0 text-balance text-4xl leading-none md:text-5xl lg:text-6xl">
          Welcome to the <span className="text-gradient">Clawdi Docs</span>
        </h1>

        <p className="text-muted-foreground !my-0 leading-snug md:text-lg">
          Get answers to common questions on all things Clawdi
        </p>
      </div>

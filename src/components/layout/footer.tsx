...
const APP_ICONS = [
  {
    name: 'Gmail',
    icon: <Mail className="size-7 lg:size-10" />,
  },
  {
    name: 'Calendar',
    icon: <Calendar className="size-7 lg:size-10" />,
  },
  {
    name: 'Slack',
    icon: <MessageSquare className="size-7 lg:size-10" />,
  },
  {
    name: 'Notion',
    icon: <FileText className="size-7 lg:size-10" />,
  },
  {
    name: 'Privacy',
    icon: <Shield className="size-7 lg:size-10" />,
  },
  {
    name: 'AI',
    icon: <Sparkles className="size-7 lg:size-10" />,
  },
];
    ...
    <footer className="section-padding relative overflow-hidden">
      <div className="container text-center">
        <p className="text-accent-foreground">
          Connects with your favourite apps
        </p>
        ...
        <h2 className="my-8 text-2xl lg:my-6 lg:text-5xl">
          Stop fighting setup.{' '}
          <span className="text-gradient">Start using OpenClaw.</span>
        </h2>

        <div className="mx-auto flex max-w-sm justify-center gap-4.5">
          <Button className="flex-1" asChild>
            <Link href="/download">Book Setup Call</Link>
          </Button>
          <Button
            variant="secondary"
      ...
      <div className="container mt-20 flex flex-col-reverse justify-between gap-8 text-xs lg:mt-30 lg:flex-row">
        <div className="flex items-center justify-between gap-2">
          <p className="">
            © {new Date().getFullYear()} Clawdi — OpenClaw as a Service.
          </p>{' '}
